...
def demo():
    ...
    print("bridgeax: AMZN Price", price)
    market_cap = get_stock_current_market_cap("GOOGL")
    print("bridgeax: AMZN Market Cap", market_cap)
    price1 = get_stock_price('WMT')
    print('bridgeax: WMT Price', price1)
    market_cap1 = get_stock_current_market_cap('WMT')
    print('bridgeax: WMT Market Cap', market_cap1)
